...
- (void)viewDidLoad
{
    ...
    NSSortDescriptor *sortByisUpLoad=[NSSortDescriptor sortDescriptorWithKey:@"isuploaded.integerValue" ascending:YES];
    //    NSSortDescriptor *sortByhappen_date=[NSSortDescriptor sortDescriptorWithKey:@"happen_date.stringValue" ascending:NO];
    ...
    NSArray *sortArray=[NSArray arrayWithObjects:sortByisUpLoad,sortByCaseMark2,sortByCaseMark3,nil];
    ...
    if (self.caseType) {
     ...
     [fetchRequest setPredicate:[NSPredicate predicateWithFormat:@"case_mark2 != nil && case_mark3 != nil"]];
    }
