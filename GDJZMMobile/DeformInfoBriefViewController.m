...
//添加路产损坏记录
-(void)addDeformationForRoadAsset:(RoadAssetPrice *)aRoadAsset andQuantity:(double)quantity withRemark:(NSString *)aRemark hadBad_type:(NSString *)Bad_type{
    if (![self.caseID isEmpty]) {
        if (self.citizenList.count>0) {
            ...
            newDeformation.bad_type=Bad_type;
